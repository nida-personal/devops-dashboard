...
const statusIcon  = { success: '‚úì', running: '‚ü≥', failed: '‚úó', pending: '‚ó∑' };
  ...
  return (
    <div className="card">
      ...
      <div className="card-meta">
        <span>Ìºø {pipeline.branch}</span>
        <span>‚è± {pipeline.duration}</span>
        <span>Ìµê {pipeline.triggered}</span>
      </div>
      <div className="steps">
    ...
    <div className="app">
      <header>
        <div className="header-left">
          <h1>‚öô Pipeline Dashboard</h1>
          <p>CI/CD Monitor ‚Äî IBM Consulting Demo</p>
        </div>
        <div className="stats">
